...
execute if score .brx blockyvehicles.rx matches 0 run data modify entity @s Rotation[0] set value 45.0f

execute if score .brx blockyvehicles.rx matches 22500 run data modify entity @s Rotation[0] set value 180.0f
