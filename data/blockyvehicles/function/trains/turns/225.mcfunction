...
execute if score .brx blockyvehicles.rx matches 18000 run data modify entity @s Rotation[0] set value 225.0f

execute if score .brx blockyvehicles.rx matches 4500 run data modify entity @s Rotation[0] set value 0.0f
