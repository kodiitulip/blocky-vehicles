...
execute if score .brx blockyvehicles.rx matches 27000 run data modify entity @s Rotation[0] set value 315.0f

execute if score .brx blockyvehicles.rx matches 13500 run data modify entity @s Rotation[0] set value 90.0f
